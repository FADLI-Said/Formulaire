    ...
    if ($_SESSION["user_id"] == $value["user_id"]) {
        $images .= "
            ...
            <div class='d-flex'>
                ...
                <h1 class='fs-6 d-flex align-items-center my-0 ms-1'>". $_SESSION["user_pseudo"]." <small class='text-body-secondary'>
        ...
        <img src='../../assets\img\users/" . $_SESSION["user_id"] . "/" . $value["pic_name"] . "' alt='' class='col-lg-4 col-11 mx-auto d-block'>
        ...
        <div class='border home'>
            ...
            <p class='d-flex p-2'>". $_SESSION["user_pseudo"]."<i
